defmodule Alem.Schemas.Document do
  ...
  # binary_id PK is required for cas_dedup_refs FK to work
  ...
  schema "documents" do
    ...
    # FK -> cas_objects.content_hash (enforced by migration)
    field :text_content,  :string
    field :metadata,      :map
    field :status,        :string, default: "processing"

    # CAS fields — added by migration 20260330094444_add_cas_fields_to_documents
