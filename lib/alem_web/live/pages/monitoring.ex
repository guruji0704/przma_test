defmodule AlemWeb.AdminLive.Pages.Monitoring do
  use Phoenix.Component
  alias Alem.Admin
  import AlemWeb.AdminLive.Helpers

  def render(%{monitoring: nil} = assigns) do
    ~H"""
    <div class="empty-page">Loading monitoring data…</div>
    """
  end
    ...
    <div>
      ...
      <div class="table-wrap">
        <table class="data-table">
          <thead>
            <tr>
              <th>User</th><th>Status</th><th>Files</th><th>Storage</th>
              <th>Sessions</th><th>Last Active</th><th>Joined</th><th></th>
            </tr>
          </thead>
          <tbody>
