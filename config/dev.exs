...
config :ex_aws, :s3,
  scheme: "https",
  host:
    System.get_env("AWS_S3_ENDPOINT", "in-maa-1.linodeobjects.com")
...
config :alem, AlemWeb.Endpoint,
  ...
  debug_errors: true,
  secret_key_base:
    "TYPluKe+33aYQCwORlkEwTADppYLiB7fVdKrxNk0YQBFsNtSQ9iLj4+ZNm9d4Ox5",
  watchers: [
    esbuild:
      {Esbuild, :install_and_run,
       [:alem, ~w(--sourcemap=inline --watch)]},
    tailwind:
